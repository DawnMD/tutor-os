...
export type AttendanceRecordOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"sessionId" | "studentId" | "status" | "remarks", ExtArgs["result"]["attendanceRecord"]>
...
export interface AttendanceRecordDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const attendanceRecordWithSessionIdOnly = await prisma.attendanceRecord.findMany({ select: { sessionId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many AttendanceRecords and only return the `sessionId`
   * const attendanceRecordWithSessionIdOnly = await prisma.attendanceRecord.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more AttendanceRecords and only return the `sessionId`
   * const attendanceRecordWithSessionIdOnly = await prisma.attendanceRecord.updateManyAndReturn({
   *   select: { sessionId: true },
   *   where: {
   *     // ... provide filter here
   *   },
