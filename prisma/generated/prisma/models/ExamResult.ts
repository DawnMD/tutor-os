...
export type ExamResultOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"examId" | "studentId" | "marks" | "remarks", ExtArgs["result"]["examResult"]>
...
export interface ExamResultDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const examResultWithExamIdOnly = await prisma.examResult.findMany({ select: { examId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ExamResults and only return the `examId`
   * const examResultWithExamIdOnly = await prisma.examResult.createManyAndReturn({
   *   select: { examId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more ExamResults and only return the `examId`
   * const examResultWithExamIdOnly = await prisma.examResult.updateManyAndReturn({
   *   select: { examId: true },
   *   where: {
   *     // ... provide filter here
   *   },
